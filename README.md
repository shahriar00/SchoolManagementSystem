...
### In my university course, System Analysis and Design Project, I have to complete this project with full project documentation. I generated this system based on school management from the point of view of the administrator, teacher, and student. This is really usable to add student and teacher data, delete them, update the data, show a marksheet for the students, course allocation, class selection, payment clarity, and class-wise teacher allocation.The more interesting part is the real-life project documentation generated for this project, which includes SRS, use case, case description, activity diagram, block diagram, data flow diagram, sequence diagram, ER diagram, and class diagram.
...
![scl16](https://github.com/shahriar00/SchoolManagementSystem/assets/70763173/b88a40d0-fc23-471c-8e59-26f9f5facd4f)
