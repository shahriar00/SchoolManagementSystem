...
public class studentupdate extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Student Data Update ");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(parentsname, javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(mobile)
                    .addComponent(clas)
                    .addComponent(roll)
...
//            String ParentsName = parentsname.getText();
...
//            String Address = address.getText();
            ...
            String sql = "update `studentdata` SET `student`='"+studentname.getText()+"',`parents`='"+parentsname.getText()+"',`mobile`='"+mobile.getText()+"',`class`='"+clas.getText()+"',`section`='"+section.getText()+"',`roll`='"+roll.getText()+"',`address`='"+address.getText()+"'WHERE id ='"+id.getText()+"'";
